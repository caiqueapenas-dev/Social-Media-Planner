...
export function AdminCalendarDay({ posts, onPostClick, onEdit }: AdminCalendarDayProps) {
  ...
  const handleClientClick = (clientPosts: Post[]) => {
      ...
      <div className="space-y-1">
        {clients.map(({ client, posts, count }) => (
          <div
            ...
            onClick={() => handleClientClick(posts)}
          >
            <div
